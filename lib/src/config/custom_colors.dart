// classe abstrata para não ter criação
// apenas para acessar os metodos
...
abstract class CustomColors {
  ...
  static Color customCardColor = Colors.white;
  static Color customDarkColor = Colors.black87;
